...
from swagger_client.apis.lyrics_api import LyricsApi
...
class TestLyricsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.lyrics_api.LyricsApi()

    def tearDown(self):
        pass

    def test_matcher_lyrics_get_get(self):
        """
    ...
    def test_track_lyrics_get_get(self):
        """
