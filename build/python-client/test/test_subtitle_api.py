...
from swagger_client.apis.subtitle_api import SubtitleApi
...
class TestSubtitleApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.subtitle_api.SubtitleApi()

    def tearDown(self):
        pass

    def test_matcher_subtitle_get_get(self):
        """
    ...
    def test_track_subtitle_get_get(self):
        """
