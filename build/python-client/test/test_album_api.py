...
from swagger_client.apis.album_api import AlbumApi
...
class TestAlbumApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.album_api.AlbumApi()

    def tearDown(self):
        pass

    def test_album_get_get(self):
        """
    ...
    def test_artist_albums_get_get(self):
        """
